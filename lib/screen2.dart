        ...
        Row(
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("$data",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 15),),
                SizedBox(height: 10),
                Text("4 items | 28/10/20  11:08 PM",style: TextStyle(color: Colors.white,fontSize: 10)),
              ],
            ),
